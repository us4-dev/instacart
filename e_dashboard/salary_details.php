...
<div class="row">
  <div class="col-xs-12">
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>e_dashboard.php" data-original-title="<?php echo $_data['text_6'];?>"><i class="fa fa-dashboard"></i></a> </div>
        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        	<?php
				...
				die();*/
				$result = mysqli_query($link,"Select *,m.month_name,y.xyear as year_name from tbl_add_employee_salary_setup es inner join tbl_add_month_setup m on m.m_id = es.month_id inner join tbl_add_year_setup y on y.y_id = es.xyear where es.emp_name = '". (int)$_SESSION['objLogin']['eid'] . "' AND es.branch_id = '". (int)$_SESSION['objLogin']['branch_id'] . "' order by emp_id desc");
            ...
            <td>
            <a class="btn btn-success ams_btn_special" data-toggle="tooltip" href="javascript:;" onclick="$('#nurse_view_<?php echo $row['emp_id']; ?>').modal('show');" data-original-title="View"><i class="fa fa-eye"></i></a>
				  ...
				  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-xs-6"> 
                        ...
                        <b><?php echo $_data['text_11'];?> :</b> <?php echo $_SESSION['objLogin']['e_pre_address']; ?><br/></div>
                        <div class="col-xs-6"><b><?php echo $_data['text_12'];?> :</b> <?php echo $_SESSION['objLogin']['e_per_address']; ?><br/>
                        <b><?php echo $_data['text_3'];?> :</b> <?php echo $row['month_name']; ?><br/>
                        <b><?php echo $_data['text_4'];?> :</b> <?php echo $row['year_name']; ?><br/>
						<b><?php echo $_data['text_5'];?> :</b> <?php echo $ams_helper->currency($localization, $row['amount']); ?><br/>
                      </div>
                    </div>
                  </div>
