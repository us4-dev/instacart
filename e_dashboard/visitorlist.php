        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-warning ams_btn_special" data-toggle="tooltip" href="<?php echo WEB_URL;?>e_dashboard/addvisitor.php?id=<?php echo $row['vid']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a> <!--<a class="btn btn-danger ams_btn_special" data-toggle="tooltip" onclick="deleteFloor(<?php echo $row['vid']; ?>);" href="javascript:;" data-original-title="<?php //echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>--> </td>
            </tr>
...
/*function deleteFloor(Id){
	...
	if(iAnswer){
		window.location = '<?php //echo WEB_URL; ?>e_dashboard/visitorlist.php?id=' + Id;
	}
  }*/
