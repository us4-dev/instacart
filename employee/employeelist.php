        ...
        <table class="table sakotable table-bordered table-striped dt-responsive">
          <thead>
            <tr>
              ...
              <th><?php echo $_data['v10'];?></th>
              <th><?php echo $_data['v11'];?></th>
              <th><?php echo $_data['v12'];?></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><label class="label label-primary ams_label"><?php echo $row['employee_type']; ?></label></td>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-xs-6"> <b><?php echo $_data['add_new_form_field_text_1'];?> :</b> <?php echo $row['e_name']; ?><br/>
							...
							<b><?php echo $_data['v10'];?> : </b> <?php echo $ams_helper->mySqlToDatePicker($row['visa_expiry']); ?><br/>
							<b><?php echo $_data['v11'];?> : </b> <?php echo $ams_helper->mySqlToDatePicker($row['passport_expiry']); ?><br/>
							<b><?php echo $_data['v12'];?> : </b> <label class="label label-success"><?php echo $row['employee_type']; ?></label><br/>
                          </div>
                        </div>
                      </div>
                    </div>
