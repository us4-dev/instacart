...
<div class="row">
  <div class="col-md-12">
    <div align="right" style="margin-bottom:1%;"><a data-original-title="<?php echo $_data["invoice_print_text"];?>" data-toggle="tooltip" class="btn btn-success btn_save" href="javascript:void(0);"><i class="fa fa-print"></i> </a></div>
