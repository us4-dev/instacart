    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        <?php
			$result = mysqli_query($link,"Select *,m.month_name,y.xyear from tbl_add_maintenance_cost mc inner join tbl_add_month_setup m on m.m_id = mc.xmonth inner join tbl_add_year_setup y on y.y_id = mc.xyear where mc.branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " order by mcid desc");
