            ...
            <table class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php if($row['mc_status'] == '1'){echo '<label class="label label-success ams_label">'.$_data['add_new_form_field_text_12'].'</label>';} else{echo '<label class="label label-danger ams_label">'.$_data['add_new_form_field_text_13'].'</label>';}?>
                  </td>
                  <td><a class="btn btn-success ams_btn_special" data-toggle="tooltip" href="javascript:;" onClick="$('#nurse_view_<?php echo $row['mc_id']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>"><i class="fa fa-eye"></i></a> <a class="btn btn-warning ams_btn_special" data-toggle="tooltip" href="<?php echo WEB_URL;?>management/add_m_committee.php?id=<?php echo $row['mc_id']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a> <a class="btn btn-danger ams_btn_special" data-toggle="tooltip" onClick="deleteManagementMember(<?php echo $row['mc_id']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-xs-6"> <b><?php echo $_data['add_new_form_field_text_1'];?> :</b> <?php echo $row['mc_name']; ?><br/>
                                ...
                                <b><?php echo $_data['add_new_form_field_text_6'];?> :</b> <?php echo $row['mc_per_address']; ?><br/></div>
                                <div class="col-xs-6"><b><?php echo $_data['add_new_form_field_text_7'];?> :</b> <?php echo $row['mc_nid']; ?><br/>
