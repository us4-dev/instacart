...
<div class="row">
  <div class="col-xs-12">
    ...
    <div id="you" class="alert alert-success alert-dismissable" style="display:<?php echo $addinfo; ?>">
      ...
      <?php echo $msg; ?> </div>
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>o_dashboard/addcomplain.php" data-original-title="<?php echo $_data['text_3'];?>"><i class="fa fa-plus"></i></a> <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>o_dashboard.php" data-original-title="<?php echo $_data['home_breadcam'];?>"><i class="fa fa-dashboard"></i></a> </div>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-xs-6"> <b><?php echo $_data['text_7'];?> :</b> <?php echo $row['c_date']; ?><br/>
                            ...
                            <b><?php echo $_data['text_12'];?> :</b> <?php echo $row['c_year']; ?><br/></div>
							<div class="col-xs-6">
...
function deleteComplain(Id){
	...
	if(iAnswer){
		window.location = '<?php echo WEB_URL; ?>o_dashboard/complainlist.php?id=' + Id;
	}
  }
