      ...
      <div class="box-body">
		...
		$result = mysqli_query($link,"Select *,ow.o_name,ow.image,m.month_name,y.xyear as y_xyear from tbl_add_fund fu inner join tbl_add_owner ow on ow.ownid = fu.owner_id inner join tbl_add_month_setup m on m.m_id = fu.month_id inner join tbl_add_year_setup y on y.y_id = fu.xyear where fu.branch_id = ".(int)$_SESSION['objLogin']['branch_id']." order by fu.fund_id desc");
            ...
            <tr>
              ...
              <td><a class="btn btn-success ams_btn_special" data-toggle="tooltip" href="javascript:;" onclick="$('#nurse_view_<?php echo $row['fund_id']; ?>').modal('show');" data-original-title="Details View"><i class="fa fa-eye"></i></a>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-xs-6"> <b><?php echo $_data['text_2'];?> :</b> <?php echo $row['o_name']; ?><br/>
                            <b><?php echo $_data['text_3'];?> :</b> <?php echo $row['month_name'];?><br/>
                          </div>
                          <div class="col-xs-6">
                            <b><?php echo $_data['text_9'];?> : </b> <?php echo $ams_helper->currency($localization, $row['total_amount']); ?><br/>
                            <b><?php echo $_data['text_10'];?> :</b> <?php echo $row['f_date']; ?><br/>
							<b><?php echo $_data['text_7'];?> :</b> <?php echo $row['purpose']; ?><br/>
                          </div>
                        </div>
                      </div>
                    </div>
