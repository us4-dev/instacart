...
<script type="text/javascript">
	function getVisitorsInfo(){
		...
		/*else if(v_date != '' && month_id != ''){
			...
			window.open('report/visitor_info_date.php?vid=' + v_date,'_blank');
			//alert('Please select all 3 fields');
		}
		else if(month_id != ''){
			window.open('report/visitor_info_month.php?mid=' + month_id,'_blank');
			//alert('Please select all 3 fields');
		}
		else if(xyear != ''){
			window.open('report/visitor_info_year.php?yid=' + xyear,'_blank');
			//alert('Please select all 3 fields');
		}
		else{
