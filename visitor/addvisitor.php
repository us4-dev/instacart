...
if(isset($_POST['txtName'])){
	if(isset($_POST['hdn']) && $_POST['hdn'] == '0'){
		$month = date('m');
		$year = date('Y');
		$sql = "INSERT INTO `tbl_visitor`(issue_date,name,mobile,address,floor_id,unit_id,intime,outtime,xmonth,xyear,branch_id,CPR) values('$_POST[txtIssueDate]','$_POST[txtName]','$_POST[txtMobile]','$_POST[txtAddress]','$_POST[ddlFloorNo]','$_POST[ddlUnitNo]','$_POST[txtInTime]','$_POST[txtOutTime]',$month,$year,'" . $_SESSION['objLogin']['branch_id'] . "','$_POST[CPR]')";
		...
		$sql = "UPDATE `tbl_visitor` SET `issue_date`='".$_POST['txtIssueDate']."',`name`='".$_POST['txtName']."',`mobile`='".$_POST['txtMobile']."',`address`='".$_POST['txtAddress']."',`floor_id`='".$_POST['ddlFloorNo']."',`unit_id`='".$_POST['ddlUnitNo']."',`intime`='".$_POST['txtInTime']."',`outtime`='".$_POST['txtOutTime']."',`CPR`='".$_POST['CPR']."' WHERE vid='".$_GET['id']."'";
		mysqli_query($link,$sql);
    ...
    <div class="box box-success">
      ...
      <form onSubmit="return validateMe();" action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
        <div class="box-body row">
          ...
          <div class="form-group col-md-12">
            <label for="CPR"> <?php echo $_data['text_144'];?> :</label>
            <input type="text" name="CPR" value="<?php echo $CPR;?>" id="CPR" class="form-control" />
          </div>
		  <div class="form-group col-md-6">
